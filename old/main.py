...
class AutoClicker:
    def __init__(self, window_title, target_colors_hex, nearby_colors_hex, logger, percentages: float,
        ...
        ]  # Pictures which should be clicked
    ...
    def toggle_script(self):
        ...
        self.logger.log(f'Mode changed: {r_text}')
    ...
    def click_color_areas(self):
        ...
        if not windows:
            self.logger.log(
                f"No window with the title: {self.window_title} was found. Open the Blum web application and execute the script again.")
            return
...
if __name__ == "__main__":
    ...
    while answer is None:
        points_key = logger.input("Should the bot continue playing automatically? | 1 - YES / 0 - NO: ")
    ...
    try:
        ...
        logger.log(f"An error has occured: {e}")
